// Single source of truth for the chart variations: the PNG catalogue used both
// by `shots.mjs` (which renders them) and by `deck.mjs` (which lays them out in
// the PowerPoint kit). Every entry names the dataset, the viz and the settings
// that make the variation, plus the wording that describes it.
...
export const CARD = { width: 900, height: 520 };
...
export const GROUPS = [
  {
    ...
    usage: "Comparer des catégories entre elles, ou suivre un petit nombre de périodes. Le réflexe par défaut quand on hésite.",
    fields: [
      "Mesure(s) affichée(s)",
      "Agrégation (somme / moyenne / nombre / min / max)",
      "Dimension de l'axe X",
      "Éclatement par une 2ᵉ dimension",
      "Tri des barres",
      "Empilement (aucun / empilé / 100 %)",
      "Nom de l'axe X",
      "Nom de l'axe Y + unité",
      "Valeurs affichées sur les barres (oui / non)",
      "Légende (oui / non)",
      "Ligne d'objectif",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Un classement (top 10, palmarès), ou des libellés de catégories trop longs pour tenir sous un axe X.",
    fields: [
      "Mesure(s) affichée(s)",
      "Agrégation",
      "Dimension (une ligne par…)",
      "Éclatement par une 2ᵉ dimension",
      "Tri (et nombre de lignes gardées)",
      "Empilement (aucun / empilé / 100 %)",
      "Nom de l'axe des valeurs + unité",
      "Valeurs affichées (oui / non)",
      "Légende (oui / non)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Suivre une évolution dans le temps, en particulier sur beaucoup de points.",
    fields: [
      "Mesure(s) affichée(s)",
      "Agrégation",
      "Période affichée et granularité (jour / semaine / mois / trimestre)",
      "Éclatement par une 2ᵉ dimension",
      "Nom de l'axe X",
      "Nom de l'axe Y + unité",
      "2ᵉ axe Y (quelle série ?)",
      "Points visibles sur la ligne (oui / non)",
      "Valeurs affichées (oui / non)",
      "Légende (oui / non)",
      "Ligne d'objectif",
      "Courbe de tendance (oui / non)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Montrer une composition qui évolue : le total et la part de chacun, période après période.",
    fields: [
      "Mesure affichée",
      "Agrégation",
      "Période et granularité",
      "Dimension d'éclatement (les bandes)",
      "Empilement (empilé / 100 %)",
      "Nom de l'axe X",
      "Nom de l'axe Y + unité",
      "Valeurs affichées (oui / non)",
      "Légende (oui / non)",
  ...
  },
  {
    ...
    usage: "Croiser deux grandeurs d'échelles différentes : volume et taux, réalisé et objectif.",
    fields: [
      "Mesure en barres",
      "Mesure(s) en courbe",
      "Agrégation",
      "Dimension de l'axe X",
      "Axe secondaire : quelle série à droite ?",
      "Nom de l'axe X",
      "Nom de l'axe Y gauche + unité",
      "Nom de l'axe Y droit + unité",
      "Valeurs affichées (oui / non)",
      "Légende (oui / non)",
      "Ligne d'objectif",
    ],
  ...
  },
  {
    ...
    usage: "Une répartition à un instant donné. À réserver aux répartitions de 2 à 6 parts.",
    fields: [
      "Mesure affichée",
      "Agrégation",
      "Dimension (les parts)",
      "Tri des parts",
      "Anneau ou disque plein",
      "Total au centre (oui / non)",
      "Étiquettes : pourcentage / valeur / les deux / aucune",
      "Légende (oui / non)",
      "Regroupement des petites parts (« Autres » à partir de … %)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Le chiffre clé, seul. C'est ce qu'on lit en premier, en haut du tableau de bord.",
    fields: [
      "Mesure affichée",
      "Agrégation",
      "Période couverte",
      "Format : nombre / pourcentage / devise",
      "Décimales",
      "Préfixe / suffixe",
      "Libellé sous le chiffre",
      "Seuil de couleur (au-dessus de … → vert, en dessous → rouge)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Le chiffre clé et son évolution : où on en est, et dans quel sens ça va.",
    fields: [
      "Mesure affichée",
      "Agrégation",
      "Période affichée",
      "Comparaison : période précédente / première valeur / moyenne",
      "Afficher la valeur de comparaison (oui / non)",
      "Format du chiffre",
      "Sens favorable (une hausse est-elle une bonne nouvelle ?)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Expliquer un écart : d'où l'on part, ce qui ajoute, ce qui retire, où l'on arrive.",
    fields: [
      "Mesure affichée",
      "Postes et leur ordre (de gauche à droite)",
      "Point de départ (report, budget, N-1…)",
      "Colonne de total (oui / non)",
      "Couleurs augmentation / diminution",
      "Nom de l'axe Y + unité",
      "Valeurs affichées (oui / non)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "Situer une valeur sur une échelle bornée : satisfaction, taux d'occupation, note.",
    fields: [
      "Mesure affichée",
      "Agrégation",
      "Minimum et maximum de l'échelle",
      "Plages colorées : bornes, couleurs, libellés",
      "Objectif",
      "Format du chiffre (suffixe, décimales)",
    ],
    shots: [
  ...
  },
  {
    ...
    usage: "L'avancement vers un objectif chiffré : où en est-on du chemin ?",
    fields: [
      "Mesure affichée",
  ...
  },
  {
    ...
    usage: "Chercher une relation entre deux mesures et repérer les points atypiques.",
    fields: [
      "Mesure de l'axe X",
      "Mesure de l'axe Y",
      "Un point = quoi ? (une commune, un client, une commande…)",
      "Mesure portée par la taille des bulles",
      "Étiquettes des points (oui / non)",
