...
function ViewToggle({
  ...
  return (
    ...
    >
      <button
        style={{ ...btn(mode === "table"), borderRadius: 999 }}
      ...
      >
        <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
          ...
          />
          <path
            d="M2.5 8H17.5M2.5 12H17.5M7.5 3.5V16.5M12.5 3.5V16.5"
            stroke="currentColor"
            strokeWidth="1.6"
          />
        </svg>
      ...
      <button
        style={{ ...btn(mode === "chart"), borderRadius: 999 }}
        onClick={() => onChange("chart")}
        aria-label="Graphique"
      >
        <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
          <path
            d="M3 14L7.5 8.5L11 11.5L17 4.5"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
...
export function BottomBar({
  ...
  return (
    <Group
      ...
      style={{
        padding: "10px 16px",
        borderTop: `1px solid ${MB_COLORS.border}`,
        ...
        <Button
          ...
          leftSection={
            <svg width="15" height="15" viewBox="0 0 20 20" fill="none">
              <rect x="3" y="9" width="3.2" height="8" rx="0.5" fill="currentColor" />
              <rect x="8.4" y="4" width="3.2" height="13" rx="0.5" fill="currentColor" />
              <rect x="13.8" y="11" width="3.2" height="6" rx="0.5" fill="currentColor" />
            </svg>
          }
        >
          Visualisation
      ...
      <Group gap="md">
        ...
        {canExportImage && (
          <UnstyledButton
            ...
            style={{ display: "inline-flex", color: MB_COLORS.textTertiary }}
          >
            <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
              <path
