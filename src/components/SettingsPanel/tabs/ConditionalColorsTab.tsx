...
export function ConditionalColorsTab({ vizId, settings, onChange, allCols }: ConditionalColorsTabProps) {
  ...
  const add = () => onChange({ colorRules: [...rules, { column: allCols[0]?.value, operator: ">", value: 0, color: ACCENT_COLORS[3] }] });
